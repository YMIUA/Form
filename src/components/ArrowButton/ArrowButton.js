...
const ArrowButton = props => (
        <div className='stepArrow'>
            ...
            {props.step===4 ? <button value='finish' onClick={props.finishForm} disabled={!props.isValid}>Завершить</button> :
                <button value={'next'} onClick={props.nextStep} disabled={!props.isValid}>
                    <span>Cледующий</span>
